...
scatter(dppAMPK1(:,1),dppAMPK1(:,2),100,[0.09412 0.4549 0.80392],'o','filled');
scatter(dppAMPK2(:,1),dppAMPK2(:,2),50,[0.09412 0.4549 0.80392],'o','filled');
...
% line(TOUT2, NADHsim, 'Color', 'r', 'LineWidth', 2);
...
%     hold on;
%      scatter(dpNADH(:,1),dpNADH(:,2).*0.2, 'ks','filled');
%      hold on
%       scatter(dpNADH(:,1),dpNADH(:,2).*scalary, 50,'ko', 'LineWidth', 2);
...
%      
 figure()%%%%%%%%%%%%%%%%%%%%%ATP
     ...
     scatter(dpATP(:,1),dpATP(:,2).*scalary,50,[0.09412 0.4549 0.80392],'o', 'LineWidth', 2);
     hold on;
        [score,scalary] = findSquares(TOUT2,ATPsim,dpATP4);
     scatter(dpATP4(:,1),dpATP4(:,2).*scalary, 50, [0.09412 0.4549 0.80392],'^', 'LineWidth', 2);
...
% 
     ...
     hold on;
     scatter(dpSIRT1_1(:,1),dpSIRT1_1(:,2).*scalary, 100,[0.09412 0.4549 0.80392],'o','filled');
%      hold on;
%       scatter(dpSIRT1_2(:,1),dpSIRT1_2(:,2).*scalary, 50,'ko','LineWidth', 2);
      ...
      h = legend( 'simulation', 'Chen et al. 2011',  'Location', 'North','fontsize',fontsize1);%r3-ref37
       box on
% 
%       
figure()%%%%%%%%%%%%%%%%%%%%%%%%%%%%HIF
...
hold on;
scatter(dpHIF1a2(:,1),dpHIF1a2(:,2).*scalary2, 50,[0.09412 0.4549 0.80392],'^','LineWidth', 2);
% hold on;
% scatter(dpHIF1a3(:,1),dpHIF1a3(:,2).*scalary3, 50,[0 0.4470 0.7410],'o','LineWidth', 2);
hold on;
scatter(dpHIF1a_1(:,1),dpHIF1a_1(:,2).*scalary, 100,[0.09412 0.4549 0.80392],'o','filled');
hold on;
scatter(dpHIF1a_2(:,1),dpHIF1a_2(:,2).*scalary, 50,[0.09412 0.4549 0.80392],'o','LineWidth', 2);
...
% h = legend( 'simulation', 'Cavadas et al. 2015', 'Cavadas et al. 2015','Haugen et al. 2012', 'Cavadas et al. 2015', 'Location', 'North','fontsize',fontsize1);%ref108;rg11

...
function [param] = getParam(ver) %version

if ver==1  %version indext
     k_input_O2 = 1; %1;%normal 21% =
     k_etc_f = 1;
     k_etc_b = 0.1; %30
     Jm_etc_O2 = 10;
     k_O2_ROS = 0.5; 
...
elseif ver==2 %240110
    k_input_O2 = 0.3; %1;%normal 21% =
     ...
     kd_SIRT1 = 0.04;
     alpha = 0.01;
elseif ver==3 %240407改了HIF中SIRT term;为了减少oscillation
    k_input_O2 = 0.3; %1;%normal 21% =
     k_etc_f = 3;
     k_etc_b = 0.3; %30
     Jm_etc_O2 = 10;
     ...
     kd_SIRT1 = 0.04;
     alpha = 0.01;
      Ja_SIRT1_HIF1a = 0;%%%%new
end

% if strcmp(setting,'hypoxia')
%     k_o2input = k_o2input/4;
% elseif strcmp(setting,'HighpAMPK')
%     fold = 2;
%     k_ampk_phos1 = k_ampk_phos1*fold;
%        k_ampk_phosLKB = k_ampk_phosLKB*fold;
%        k_ampk_phosCaM  = k_ampk_phosCaM*fold;
% end

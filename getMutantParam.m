...
%         k_phosCaM_AMPK  = k_phosCaM_AMPK*fold;
        ...
        elseif strcmp(setting,'SIRTinhibitor')
        fold = 0.8;
        kd_SIRT1 = kd_SIRT1*fold;
    elseif strcmp(setting,'AMPKinhibitor&hypoxia')
 k_input_O2 = k_input_O2/5;%氧气输入速率 k_o2input 
  k_phos1_AMPK = k_phos1_AMPK*2;
